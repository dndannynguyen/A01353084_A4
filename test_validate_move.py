...
class TestValidateMove(TestCase):
    def test_validate_move_top_left_go_up(self):
        first_character = {'Room': 0, 'Floor': 4, 'Health': 5}
        first_direction = '2'
    ...
    def test_validate_move_top_left_go_left(self):
        my_character = {'Room': 0, 'Floor': 4, 'Health': 5}
        my_direction = '1'
    ...
    def test_validate_move_top_left_go_right(self):
        the_character = {'Room': 0, 'Floor': 4, 'Health': 5}
        the_direction = '4'
    ...
    def test_validate_move_top_right_go_left(self):
        first_user = {'Room': 4, 'Floor': 4, 'Health': 3}
        first_move = '1'
    ...
    def test_validate_move_bottom_left_go_down(self):
        second_user = {'Room': 0, 'Floor': 0, 'Health': 3}
        second_move = '3'
    ...
    def test_validate_move_with_invalid_direction(self):
        the_tester = {'Room': 0, 'Floor': 0, 'Health': 3}
        the_move = 'Left'
